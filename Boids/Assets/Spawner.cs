...
{
    static public Spawner S;//Singlton
    static public List<Boid> boids;
    //Ёти пол€ позвол€ют настраивать пор€док создани€ объектов
    ...
    //Ёти пол€ позвол€ют настраивать стайное поведение объектов
    [Header("Set in Inspector: Boids")]
    public float velocity = 30f;
    public float neighborDis = 30f;
